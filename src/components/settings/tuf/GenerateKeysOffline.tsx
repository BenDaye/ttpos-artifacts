...
export const GenerateKeysOffline: React.FC<GenerateKeysOfflineProps> = ({
  ...
  return (
    <div className="bg-card p-6 rounded-lg border-2 border-blue-500">
      <button
      ...
      {showStep1 && (
        <>
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <ol className="text-foreground text-sm leading-relaxed list-decimal list-inside ml-2 space-y-1 mb-3">
                  ...
                  <li>Copy the generated script and save it as <code className="bg-muted px-1 rounded">{generateInitTufKeysScriptFileName}</code> on a secure offline machine</li>
                ...
                <ol className="text-foreground text-sm leading-relaxed list-decimal list-inside ml-2 space-y-1" start={5}>
                  ...
                  <li>Use the generated <code className="bg-muted px-1 rounded">{bootstrapPayloadFileName}</code> to proceed with bootstrap</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-foreground mb-2 font-roboto">Keys Threshold</label>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm text-foreground mb-1">Root</label>
                  <input
                    type="number"
                    min={1}
                ...
                <div>
                  <label className="block text-sm text-foreground mb-1">Targets</label>
                  <input
                    type="number"
                    min={1}
                ...
                <div>
                  <label className="block text-sm text-foreground mb-1">Timestamp</label>
                  <input
                    type="number"
                    min={1}
                ...
                <div>
                  <label className="block text-sm text-foreground mb-1">Snapshot</label>
                  <input
                    type="number"
                    min={1}
                ...
                <div>
                  <label className="block text-sm text-foreground mb-1">Delegation</label>
                  <input
                    type="number"
                    min={1}
