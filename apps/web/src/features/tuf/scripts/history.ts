import type { TaskState, TufHistoryEntry } from './types'

export function loadHistoryFromStorage(): TufHistoryEntry[] {
...
export function saveToHistory(entry: Omit<TufHistoryEntry, 'id'>, currentHistory: TufHistoryEntry[]): TufHistoryEntry[] {
...
export function updateHistoryStatus(taskId: string, state: TaskState, currentHistory: TufHistoryEntry[]): TufHistoryEntry[] {
...
export function clearHistory(): TufHistoryEntry[] {
