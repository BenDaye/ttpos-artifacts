      ...
      {!isMobile ? (
        <div className='hidden md:flex items-center justify-between w-full gap-4'>
            ...
            {!hideSearch && (
              <div className='relative w-full max-w-xs ml-4'>
                <input
                  ...
                  className='header-search h-9 px-4 text-sm box-border focus:outline-none focus:ring-2 focus:ring-ring w-full'
                />
                {searchTerm && (
                  <button
          ...
          <div className='flex items-center gap-4'>
            {additionalButton}
            {!suppressThemeSwitcher && <ThemeSwitcher />}
            {createButtonText && (
              <button
                onClick={onCreateClick}
                className='header-action-btn hidden md:flex h-9 px-4 font-roboto items-center box-border'>
                {renderIcon()}
        ...
        <div className='flex flex-col md:hidden gap-2 mt-0'>
          <div className='flex justify-between items-center'>
            ...
            <div className='flex items-center ml-auto gap-2'>
              ...
              {createButtonText && (
                <button
                  onClick={onCreateClick}
                  className='header-action-btn md:hidden p-2.5 flex items-center justify-center'
          ...
          {title && <h2 className='header-title mb-2'>{title}</h2>}
          {!hideSearch && (
