...
export const AppBoardColumn: React.FC<AppBoardColumnProps> = ({
  ...
  const {
    ...
    hasNextPage,
    isFetchingNextPage,
  } = useAppVersionsQuery(app.AppName);
  ...
  return (
    <div className='flex flex-col w-[340px] min-w-[340px] bg-muted/30 border border-border rounded-lg flex-shrink-0'>
      ...
      <div
        ...
        className='flex-1 overflow-y-auto p-2 space-y-2 max-h-[calc(100vh-280px)]'>
        {isLoading ? (
          ...
          <>
            ...
            {hasNextPage && (
              <div className='pt-1 pb-2 flex flex-col items-center gap-2'>
                <Button
                  type='button'
                  variant='secondary'
                  size='sm'
