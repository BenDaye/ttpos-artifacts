...
基于 FaynoSync（已 fork 至本仓库 `server/`）的自托管应用更新服务，为 TTPOS 各端应用提供版本管理和更新分发。

## 架构

| 服务 | 镜像 | 端口 | 说明 |
|------|------|------|------|
| api | `ghcr.io/bendaye/ttpos-artifacts/faynosync-server:latest` | 9000 | 更新 API 服务（Go） |
| dashboard | `ghcr.io/bendaye/ttpos-artifacts/faynosync-dashboard:latest` | 3000 | Web 管理面板 |
...
- [FaynoSync 上游（已 fork）](https://github.com/ku9nov/faynoSync)
